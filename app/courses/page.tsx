...
export default function Courses() {
    return (
        ...
        <div>
            ...
            <div>
                {/*Course Container  */}
                <div className="mobile:mt-10  w-full max-w-[1280px] pr-6 pb-12 pt-12 pl-6  gap-20 left-[100px] bg-[#ffffff]  flex flex-col justify-center items-center  font-roboto">
