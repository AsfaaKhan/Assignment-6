...
export default function Testimonails() {
    return (
        <div id="testimonial" className="flex flex-col w-full  small: justify-center  top-[58886px] pt-28 pb-28 pl-16 pr-16 gap-20 bg-[#f7f7f7] mobile:bg-[#ffffff] font-roboto">
            ...
            <div className="gap-6 w-full max-w-[560px]  font-roboto flex flex-col">
                ...
                <h1 className="tablet:hidden small:hidden sm:hidden md:hidden lg:hidden  2xl:hidden font-bold text-[32px] leading-[41.6px] text-[#000000] text-center ">What Our Student Say </h1>
            ...
            <div className="  gap-12  flex flex-col ">
                ...
                <div className="  gap-8 grid grid-cols-3 mobile:grid-cols-1 small:grid-cols-1 sm:grid-cols-1">
                    <div className="  border-[1px] p-8 gap-6 border-[#000000] flex flex-col ">
                        ...
                        <div className=" gap-6 flex flex-col ">
                            <p className="  font-normal text-lg leading-[27px] text-[#000000]"> {`"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros  elementum tristique. Duis cursus, mi quis viverra ornare."`}</p>
                    ...
                    <div className=" mobile:hidden border-[1px] p-8 gap-6 border-[#000000] flex flex-col   ">
                        ...
                        <div className=" gap-6 flex flex-col ">
                            <p className="  text-[#000000] font-normal text-lg leading-[27px] "> {`"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros  elementum tristique. Duis cursus, mi quis viverra ornare."`}</p>
                            <div className="gap-5 flex ">
                                <Image
