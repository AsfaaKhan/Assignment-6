...
export default function HeroSection() {
    return (
        <div>
            {/* TEXT PICTURE  */}
            <div id="homePage" className=" w-full max-w-[1280px] h-auto top-[141px] mobile:pt-10 bg-[#FFFFFF] ">
                <div className="grid grid-cols-2 mobile:grid-cols-1 gap-6   ">
                    ...
                    <div className=" flex justify-center items-center pt-16 pb-16 pr-6 pl-6  ">
                        <div className=" flex flex-col  w-full  max-w-lg mobile:max-w-md   gap-6 bg-[#FFFFFF]  ">
