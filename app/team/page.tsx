...
export default function Team (){
    return(
        <div>
            ...
            <div id="about" className="mobile:mt-10 bg-[#f7f7f7] w-full max-w-[1280px] flex flex-col   gap-4  pt-28  pb-28 mobile:pt-12 mobile:pb-12 mobile:pr-6 mobile:pl-6 mobile:gap-12 ">
            ...
            {/* TEAM  */}
            <div className=" max-w-[1280px]  gap-16  mobile:w-[380px] mobile:gap-24 grid">
                ...
                <div className="gap-12 grid grid-cols-3 mobile:grid-cols-1">
                    ...
                    <div className="gap-6 flex flex-col items-center">
                        ...
                        <div className="w-[394.67px] h-[121px] gap-4 font-roboto">
